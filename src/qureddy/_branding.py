...
- `SOURCE_URL` points at `breachsafe/qureddy`, the canonical public
  ...
  org-migration target is documented in the repository architecture, but the repo lives
...
DESCRIPTION = "post-quantum readiness scanner for TLS and SSH endpoints"
