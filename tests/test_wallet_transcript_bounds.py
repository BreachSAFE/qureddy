...
from qureddy.scanners.wallet.indexer import _MAX_BODY_TRACE, HttpExchange, _bounded_body
...
def test_a_body_inside_the_bound_is_untouched() -> None:
    ...
    assert _bounded_body(body) == body
...
def test_the_marker_reaches_the_transcript_the_probe_result_carries() -> None:
    ...
    exchange.body_text = _bounded_body("z" * 300_000)
