...
You also need OpenSSL 3.6.3+ on your `PATH` for the TLS scanner to work end-to-end:

- macOS: `brew install openssl@3` (gets the current 3.6.x line)
- Linux: use a supported vendor build or the official OpenSSL source
- Windows: install a trusted OpenSSL 3.6.3 or newer build and set its path
