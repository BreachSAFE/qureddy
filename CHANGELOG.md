...
2. [0.9.31](#0931---2026-09-13)
3. [0.9.30](#0930---2026-09-12)
4. [0.9.24](#0924---2026-09-10)
5. [0.9.23](#0923---2026-09-09)
6. [0.9.22](#0922---2026-09-08)
7. [0.9.21](#0921---2026-09-08)
8. [0.9.20](#0920---2026-09-07)
9. [0.9.19](#0919---2026-09-07)
10. [0.9.18](#0918---2026-09-07)
11. [0.9.17](#0917---2026-09-07)
12. [0.9.16](#0916---2026-09-07)
13. [0.9.15](#0915---2026-09-07)
14. [0.9.13](#0913---2026-09-06)
15. [0.9.12](#0912---2026-09-06)
16. [0.9.11](#0911---2026-09-06)
17. [0.9.10](#0910---2026-09-06)
18. [0.9.9](#099---2026-09-04)
19. [0.9.8](#098---2026-09-02)
20. [0.9.7](#097---2026-09-02)
21. [0.9.6](#096---2026-09-02)
22. [0.9.5](#095---2026-09-02)
23. [0.9.4](#094---2026-09-02)
24. [0.9.3](#093---2026-09-01)
25. [0.9.2](#092---2026-09-01)
26. [0.9.1](#091---2026-08-31)
27. [0.9.0.10](#09010---2026-08-30)
28. [0.9.0.9](#0909---2026-08-26)
29. [0.9.0.8](#0908---2026-08-26)
30. [0.9.0.7](#0907---2026-08-26)
31. [0.9.0.6](#0906---2026-08-26)
32. [0.9.0.5](#0905---2026-08-26)
33. [0.9.0.4](#0904---2026-08-26)
34. [0.9.0.3](#0903---2026-08-25)
35. [0.9.0.2](#0902---2026-08-24)
36. [0.9.0.1](#0901---2026-08-24)
37. [0.9.0.0](#0900---2026-08-24)
...
- Emit native CycloneDX 1.7 elliptic-curve and certificate relationship fields
  while preserving the pinned serializer compatibility aliases ([PR #962](https://github.com/BreachSAFE/qureddy/pull/962)).

## [0.9.23] - 2026-09-09

### Fixed

- Emit observed TLS named groups in CycloneDX 1.7 `tlsGroups` while retaining
  TLS legacy cipher suites in their protocol graph ([PR #899](https://github.com/BreachSAFE/qureddy/pull/899)).

## [0.9.22] - 2026-09-08

### Fixed

- Add cross-format output conformance validation for Rich, JSON, JSONL, and
  CycloneDX CBOM artifacts.
- Preserve SSH protocol, linked algorithm evidence, and CWE context in the
  Rich findings table.
...
- Preserve separate deprecated-protocol and weak-cipher findings, including
  runtime attribution, instead of allowing the renderer to erase one fact
  ([issue #888](https://github.com/BreachSAFE/qureddy/issues/888),
  [PR #892](https://github.com/BreachSAFE/qureddy/pull/892)).
...
- Make NIST PQC categories authoritative and add source-backed classical security
  levels to CBOM algorithm properties.
- Preserve observed IKE evidence by honoring an explicit ephemeral source-port
  request instead of rewriting it to privileged UDP/500 ([issue #856](https://github.com/BreachSAFE/qureddy/issues/856), [PR #857](https://github.com/BreachSAFE/qureddy/pull/857)).

## [0.9.18] - 2026-09-07

### Fixed

- Preserve the requested STARTTLS profile in canonical scan targets and every
  machine-readable output surface, including CBOM metadata ([issue #782](https://github.com/BreachSAFE/qureddy/issues/782), [PR #854](https://github.com/BreachSAFE/qureddy/pull/854)).

## [0.9.17] - 2026-09-07

### Changed

- Harden the TLS capability regression test so a host-installed legacy OpenSSL
  cannot perform an unintended live probe and alter the readiness assertion
  ([PR #850](https://github.com/BreachSAFE/qureddy/pull/850)).

## [0.9.16] - 2026-09-07

### Fixed

- Correct CBOM classical-strength ratings for RC4-64-MD5, arcfour256, and
  TLS_RSA_EXPORT1024_WITH_RC4_56_SHA, and stop fabricating a strength for
  ENCR_3IDEA ([issue #825](https://github.com/BreachSAFE/qureddy/issues/825),
  [PR #825](https://github.com/BreachSAFE/qureddy/pull/825)).
- Preserve a TLS hybrid-probe failure when a separate classical-control probe
  succeeds, preventing a timeout from becoming a fabricated cryptographic
  verdict ([issue #836](https://github.com/BreachSAFE/qureddy/issues/836),
  [PR #847](https://github.com/BreachSAFE/qureddy/pull/847)).
...
- Preserve live TLS protocol version and negotiated cipher-suite fields by parsing
  OpenSSL's explicit `-brief` transcript, including status lines emitted on stderr
  ([issue #830](https://github.com/BreachSAFE/qureddy/issues/830),
  [PR #845](https://github.com/BreachSAFE/qureddy/pull/845)).

## [0.9.13] - 2026-09-06

### Changed

- Require the container smoke gate to verify both OpenSSL 3.5.8/PQC capability and
  the intentional OpenSSL 1.0.2u legacy probing capability ([PR #819](https://github.com/BreachSAFE/qureddy/pull/819)).

## [0.9.12] - 2026-09-06

### Fixed

- Report broken MD5 and deprecated SHA-1 certificate issuer signatures as actionable
  findings, and surface expired TLS certificates from the captured certificate evidence
  ([issue #789](https://github.com/BreachSAFE/qureddy/issues/789),
  [PR #813](https://github.com/BreachSAFE/qureddy/pull/813)).
...
- Legacy OpenSSL compatibility lane: an isolated legacy runtime probes ciphers the pinned
  OpenSSL 3.5 build refuses to offer, and reports `local_openssl_missing` when that runtime
  is absent rather than reading clean
  ([PR #792](https://github.com/BreachSAFE/qureddy/pull/792)).
