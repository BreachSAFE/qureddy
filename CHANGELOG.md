...
- `--retry-on` now lists the valid retry categories in help and invalid-value errors.
- `--quiet --log PATH` preserves the documented INFO-level diagnostic records in the
  explicit log file while keeping terminal output quiet.
...
- Kept the Rich evidence selector within the blocking Xenon complexity ceiling
  while preserving retry ordering and probe-free offered-evidence handling.

## [0.2.68] - 2026-08-24

### Fixed

- Rich SSH output no longer crashes when rendering offered KEX/host-key evidence
  that has no probe-attempt metadata.
- SSH evaluation preserves the classical-downgrade interpretation for mixed
  hybrid and classical offers, while ignoring unknown vendor KEX names.
...
- Decoupled posture evaluation from protocol-specific finding prefixes by introducing
  semantic posture signals and shared classification helpers.
- Removed output-adapter imports of TLS-private scanner modules while preserving
  legacy evidence and golden-output compatibility.
- Added an architecture-boundary regression test covering the output/scanner seam.

## [0.2.64] - 2026-08-24

### Changed

- Updated architecture and CLI documentation for JSONL, output-directory bundles,
  semantic ownership, and the deferred scanner-extension boundary.

## [0.2.63] - 2026-08-24

### Fixed

- Split posture-evaluation helpers so the enforced Xenon complexity gate passes
...
- Weak SSH key-exchange algorithms now retain named evidence, so CISO evaluation
  and CBOM output identify the specific weak KEX offered.
...
- Added a typed, protocol-neutral scanner contract shared by the TLS and SSH
  collectors without changing `ScanResult` or any output format.
- Added architecture documentation and compatibility-preserving scanner contract tests.

## [0.2.59] - 2026-08-24

### Added

- Added direct `--format jsonl` output with stable finding identities for
  Nuclei/Osmedeus-style streaming workflows.
- Expanded `--output-dir` into a complete evidence bundle containing JSON, CBOM,
  JSONL, and Rich text projections from one scan.

## [0.2.58] - 2026-08-24

### Added

- Added a protocol-neutral, evidence-backed CISO evaluation contract shared by
  TLS and SSH adapters, with the same summary and observed facts in Rich, JSON,
  and CycloneDX CBOM output.
- Added explicit observed algorithm, classical alternative, and certificate
  chain-signature facts without claiming that certificate signatures are live
...
2. [0.2.64](#0264---2026-08-24)
3. [0.2.63](#0263---2026-08-24)
4. [0.2.62](#0262---2026-08-24)
5. [0.2.61](#0261---2026-08-24)
6. [0.2.60](#0260---2026-08-24)
7. [0.2.59](#0259---2026-08-24)
8. [0.2.58](#0258---2026-08-24)
9. [0.2.57](#0257---2026-08-24)
10. [0.2.56](#0256---2026-08-24)
11. [0.2.55](#0255---2026-08-24)
12. [0.2.53](#0253---2026-08-23)
13. [0.2.52](#0252---2026-08-23)
14. [0.2.51](#0251---2026-08-23)
15. [0.2.50](#0250---2026-08-23)
16. [0.2.49](#0249---2026-08-23)
17. [0.2.48](#0248---2026-08-23)
18. [0.2.46](#0246---2026-08-23)
19. [0.2.45](#0245---2026-08-22)
20. [0.2.44](#0244---2026-08-22)
21. [0.2.43](#0243---2026-08-23)
22. [0.2.42](#0242---2026-08-22)
23. [0.2.39](#0239---2026-08-22)
24. [0.2.38](#0238---2026-08-22)
25. [0.2.37](#0237---2026-08-22)
26. [0.2.36](#0236---2026-08-22)
27. [0.2.35](#0235---2026-08-22)
28. [0.2.34](#0234---2026-08-22)
29. [0.2.33](#0233---2026-08-22)
30. [0.2.32](#0232---2026-08-22)
31. [0.2.31](#0231---2026-08-22)
32. [0.2.30](#0230---2026-08-22)
33. [0.2.29](#0229---2026-08-22)
34. [0.2.28](#0228---2026-08-22)
35. [0.2.27](#0227---2026-08-22)
36. [0.2.26](#0226---2026-08-22)
37. [0.2.25](#0225---2026-08-22)
38. [0.2.24](#0224---2026-08-22)
39. [0.2.23](#0223---2026-08-22)
40. [0.2.22](#0222---2026-08-22)
41. [0.2.21](#0221---2026-08-22)
42. [0.2.20](#0220---2026-08-22)
43. [0.2.18](#0218---2026-08-22)
44. [0.2.17](#0217---2026-08-21)
45. [0.2.16](#0216---2026-08-21)
46. [0.2.15](#0215---2026-08-21)
47. [0.2.14](#0214---2026-08-19)
48. [0.2.13](#0213---2026-08-04)
49. [0.2.12](#0212---2026-07-28)
50. [0.2.11](#0211---2026-07-28)
51. [0.2.10](#0210---2026-07-28)
52. [0.2.9](#029---2026-07-28)
53. [0.2.8](#028---2026-07-28)
54. [0.2.7](#027---2026-07-28)
55. [0.2.6](#026---2026-07-28)
56. [0.2.5](#025---2026-07-28)
57. [0.2.4](#024---2026-07-28)
58. [0.2.3](#023---2026-07-27)
59. [0.2.2](#022---2026-07-27)
