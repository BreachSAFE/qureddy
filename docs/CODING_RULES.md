...
```python
# OpenSSL 3.5 emits "Server Temp Key" but not "Negotiated TLS1.3 group"
...
Real OpenSSL 3.5+ subprocess. Verifies capability detection and `-brief` parsing against a real binary, but no network connections.
