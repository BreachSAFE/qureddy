...
> The complete, generated set of all 28 enums and every class relationship lives in
...
| Enum | Values | Meaning |
| --- | --- | --- |
| `ObservationType` | `negotiated`, `offered`, `observed`, `inferred`, `not_offered`, `not_testable` | How an observation was obtained |
