...
TLS scans require supported OpenSSL 3.5.x LTS (minimum 3.5.8) with the
`X25519MLKEM768` group. Check
the selected binary:
...
`Library:` version is within the supported 3.5.x series and the group list contains
`X25519MLKEM768`:
