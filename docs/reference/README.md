...
Information-oriented contracts ([Diátaxis](https://diataxis.fr/reference/)): exact, lookup-first
...
4. [CBOM occurrence provenance grammar](cbom-occurrence-provenance.md)
5. [JSON output reference](json-schema.md)
