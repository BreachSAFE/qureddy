...
| `qureddy:scan.nist_quantum_security_level` | always | highest observed NIST category for recognized key exchange; `0` is known classical and `unknown` means no category was established or observed |
