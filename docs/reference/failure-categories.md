...
| `local_openssl_too_old` | `3` | no | OpenSSL is below the supported 3.5.7 baseline |
| `local_openssl_version_mismatch` | `3` | no | The OpenSSL executable or linked library is outside the 3.5.x LTS series |
