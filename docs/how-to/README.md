...
4. [Scan an IP target with a custom SNI](scan-ip-with-sni.md)
5. [How to generate a CBOM](generate-a-cbom.md)
6. [Capture machine-readable output for CI](json-output-for-ci.md)
7. [Run QuReddy with a GUI](run-with-a-gui.md)
