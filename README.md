...
[![Version](https://img.shields.io/badge/version-0.2.7-blue?style=flat-square)](https://github.com/breachsafe/qureddy/blob/main/CHANGELOG.md)
...
> **Pre-release (TestPyPI):** QuReddy 0.2.7 is being published to **TestPyPI**
...
```text
BreachSAFE QuReddy 0.2.7 -- https://www.breachsafe.ai
```
...
`ghcr.io/breachsafe/qureddy:0.2.7`) or a `@sha256:` digest instead of `:latest`.
