...
[![Version](https://img.shields.io/badge/version-0.2.11-blue?style=flat-square)](https://github.com/breachsafe/qureddy/blob/main/CHANGELOG.md)
...
> **Pre-release (TestPyPI):** QuReddy 0.2.11 is being published to **TestPyPI**
...
`ghcr.io/breachsafe/qureddy:0.2.11`) or a `@sha256:` digest instead of `:latest`.
